...
public class Main_ extends JFrame {
    ...
    private void setThemeColors(Color textColor, Color backgroundColor) {
        ...
        gamePage_boardPanel.setForeground(textColor);
    ...
    private void createSettingsPage() {
        ...
        settingsPage_selectedBoardLabel = new JLabel("Game Borad");
    ...
    private void checkIfThereIsAWinner() {
        ...
        if (c2.equals(c5) && c2.equals(c8) && !c2.equals("")) {
            ...
            colorBackgroundWinnerLabels(gamePage_boardLabels[2], gamePage_boardLabels[8], gamePage_boardLabels[8]);
        }
    ...
    private boolean isTwoPlayerGameEnds(JLabel pressedLabel) {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (isGameEnds == false) {
                if (challengeComputer == true) {
                    ...
                    isTwoPlayerGameEnds(pressedLabel);
                }
            }
        }
    ...
    private void createAndShowGUI() {
        ...
        startPage_about.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(getContentPane(), aboutGame, "About Tic Tac Toc", JOptionPane.PLAIN_MESSAGE);
            }
        });
